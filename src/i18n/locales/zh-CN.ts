export default {
  ...
  specialTask: {
    ...
    webhook: {
      ...
      headersLabel: '请求头',
      headersPlaceholder: '每行一条，格式：名称: 值',
      bodyLabel: '请求体（JSON 模板）',
      bodyPlaceholder: '支持 {title}、{content}、{time} 占位符',
      titleLabel: '标题（用于 {title}）',
      titlePlaceholder: '输入通知标题',
      contentLabel: '内容（用于 {content}）',
      ...
      templateKookChannel: 'KOOK 频道',
      templateKookDirect: 'KOOK 私聊',
      templateMeow: 'MeoW',
      templateNtfy: 'ntfy',
      templateWecom: '企业微信',
      templateHint: '请将预制模板中的 &lt;&gt; 占位符（如 &lt;key&gt;、&lt;bot_token&gt;）替换为实际值',
    },
    webhookLog: {
      label: '🔔 WebHook 日志推送',
      optionLabel: '请求设置',
