export default {
  ...
  specialTask: {
    ...
    webhook: {
      ...
      titleLabel: '제목 ({title} 용)',
      titlePlaceholder: '알림 제목을 입력하세요',
      contentLabel: '내용 ({content} 용)',
      contentPlaceholder: '알림 내용을 입력하세요',
      templateLabel: '프리셋 템플릿',
      templateCustom: '사용자 정의',
      templateDiscord: 'Discord',
      templateServerChan: 'ServerChan',
      templateTelegram: 'Telegram',
      templateDingTalk: 'DingTalk',
      templateBark: 'Bark',
      templateQmsg: 'Qmsg',
      templateGotify: 'Gotify',
      templateKookChannel: 'KOOK 채널',
      templateKookDirect: 'KOOK 다이렉트',
      templateMeow: 'MeoW',
      templateNtfy: 'ntfy',
      templateWecom: '기업 위챗',
