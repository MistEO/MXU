export default {
  ...
  specialTask: {
    ...
    launch: {
      ...
      argsDescription: '模板變量 {{STATUS}} {{S_BASE64}} {{S_CSV}} {{S_JSON}} {{S_JSON_BASE64}} 表示 當前實例-所有選定任務-即時狀態，詳見 https://github.com/MistEO/MXU/blob/main/src-tauri/src/mxu_actions.rs#L207 。',
      waitLabel: '等待退出',
      waitDescription:
