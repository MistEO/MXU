...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::maa_core::maa_find_gamescope_nodes,
            commands::maa_core::maa_find_gamescope_eis_sockets,
            ...
            commands::state::maa_get_cached_gamescope_nodes,
            commands::state::maa_get_cached_gamescope_eis_sockets,
